            ...
            {invoices.length === 0 ? (
              ...
              invoices.map((invoice) => {
                const reminderColors: Record<string, string> = {
                  ...
                  REMINDED: "bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300",
                  FINAL_NOTICE: "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300",
                };
                ...
                return (
                  ...
                  >
                    <td className="py-3 text-sm font-mono text-surface-600 dark:text-surface-400">
                      {invoice.number}
                    </td>
                    ...
                    <td className="py-3 text-sm text-surface-900 dark:text-surface-100">
                    ...
                    <td className="py-3 text-sm font-semibold text-surface-900 dark:text-surface-100">
